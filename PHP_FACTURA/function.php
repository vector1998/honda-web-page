...
function delete($tblname,$field_id,$ID_Auto){

	$sql = "delete from ".$tblname." where ".$field_id."=".$ID_Auto."";
	
	return db_query($sql);
}
function edit($tblname,$form_data,$field_id,$ID_Auto){
