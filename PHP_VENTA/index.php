...
<body>
    <section class="main">
        ...
        <div class="main-wrapper">
            ...
            <div class="col-xs-3">
                    ...
                    <select class="form-control" id="Vendedor">
                        ...
                        $sql = "select ID_vendedor,Nombre from vendedor";
                        $result = db_query($sql);
                        while ($row = mysqli_fetch_object($result)) {
                            ?>
                            <option value="<?php echo $row->ID_vendedor; ?>"><?php echo $row->Nombre; ?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="col-xs-3">
        ...
        <div class=" col-xs-3">
                ...
                <label></label>
                <br><br>
                <input class="btn btn-primary" type="button" id="calcular" onclick="calcularDatos()" name="submit" value="Registrar">
                <h5 id="mensajeVenta"></h3>
                <br>
            </form>
            <br>

            <!-- Tabla a poblar con la cotización-->
            <table id="tabla" cellspacing='20' border="1" width="100%">
                <!--tr>
                    <th>Plazo</th>
                    <th>Fecha Pago</th>
                    <th>Concepto</th>
        ...
        <form action="generarVenta.php" method="POST">
        <input type ="text" id="htmlTabla" name="htmlTabla" value="" hidden="true">
        <input type ="text" id="htmlVendedor" name="htmlVendedor" value="" hidden="true">
